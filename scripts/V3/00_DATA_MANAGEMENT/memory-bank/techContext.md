...
MethodsPaper,sub-methods02,ses-231215,run-115047,run-113409,/data03/fUSIMethodsPaper
```
...
| project_id | sub-XXXXXX | sub-methods02 | Yes |
...
fullfile(data_root, 'Data_collection', project_id, session_id, func_run)

% Functional Data Analysis
fullfile(data_root, 'Data_analysis', project_id, session_id, func_run)

% Anatomical Data Collection
fullfile(data_root, 'Data_collection', project_id, session_id, anatomic_run)

% Anatomical Data Analysis
fullfile(data_root, 'Data_analysis', project_id, session_id, anatomic_run)
