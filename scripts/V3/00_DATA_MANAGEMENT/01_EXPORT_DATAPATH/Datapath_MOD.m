function [subDataPath, subAnatPath, resultPath] = Datapath_MOD(cond)
    ...
    % These will be used by conditions that don't explicitly set subAnatPath
    defaultEmotionalContagionAnatPath = {
        ...
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad03/ses-230330/run-110153';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad05/ses-230615/run-123552';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad07/ses-230623/run-111330';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad09/ses-240216/run-103522';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad10/ses-240308/run-095114';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad11/ses-240301/run-092146';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad12/ses-240524/run-104237';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad13/ses-240607/run-102748';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad14/ses-240614/run-102319';
        '/data06/fUSIEmotionalContagion/Data_analysis/sub-Dyad15/ses-240621/run-101917'
    };
    ...
    switch cond
        ...
        case 'SOcFOS'
            ...
            % Use subset of default anatomical paths (first 11 entries for SOcFOS)
        ...
        case 'SOFC'
            ...
            % Use subset of default anatomical paths (first 11 entries for SOFC)
            subAnatPath = defaultEmotionalContagionAnatPath(1:11);
