...
Therefore, I advise to fork and _then_ clone the repo from your own fork[^SBL]. Testing and feedback is very much welcome!
...
[^SBL] For the SBL people I advise you to clone your fork in your personal (or group) folder in `data00` and to run it from there. The data will stay on the storage disks (e.g. `data03`)
